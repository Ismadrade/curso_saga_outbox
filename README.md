...
Repositório contendo o projeto desenvolvido do curso Arquitetura de Microsserviços: Padrão Saga Orquestrado, ministrado por Victor Hugo Negrisoli para a plataforma 
**Udemy**.
...
![Arquitetura](https://github.com/vhnegrisoli/curso-udemy-microsservicos-padrao-saga-orquestrado/blob/main/Conte%C3%BAdos/Imagem%20Curso.png?raw=true)
...
Na arquitetura, temos 5 serviços:
...
![Redpanda](https://github.com/vhnegrisoli/curso-udemy-microsservicos-padrao-saga-orquestrado/blob/main/Conte%C3%BAdos/Redpanda%20Kafka.png?raw=true)
